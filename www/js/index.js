...
c.firstChild;)a.appendChild(b);return a},qsA='querySelectorAll',$=function(a,b){b=typeof b=='string'?$(b):b||document;if(b[qsA])return b[qsA](a);a=a.match(/^(\W)?(.*)/);return b["getElement"+(a[1]?a[1]=="#"?"ById":"sByClassName":"sByTagName")](a[2])},j=function(a){for(a=0;a<4;a++)try{return a?new ActiveXObject([,"Msxml2","Msxml3","Microsoft"][a]+".XMLHTTP"):new XMLHttpRequest}catch(b){}};
